...
```{r}
fig_cc_2 +
  annotate("segment", x = c(128, 34, 11, 8, 5), xend = c(128, 34, 11, 8,5), 
           y = c(0.8,1.8,2.8,3.8,4.8), yend = c(1.2,2.2,3.2, 4.4, 5.2),
           color="red", linetype= "dotted") +
  annotate("text", x = c(129, 36, 13, 10, 7),  y = c(1,2,3,4,5),
           color="#333333", label = "P < 0.00", hjust=0, size = 3) -> fig_cc_2_1
```
